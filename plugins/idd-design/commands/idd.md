---
description: Run the full IDD methodology interactively -- decompose a task, explore options, decide on approach, generate architecture diagram. Use when you want to design a solution before writing code.
argument-hint: Describe the task you want to design, e.g. "Add user authentication with OAuth2"
---
...
Present the Mermaid diagram inline in a fenced code block.
