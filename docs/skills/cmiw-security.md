---
name: cmiw-security
description: Run CMIW security analysis on a project, parse findings, and offer to fix them. Use when the user wants to scan a codebase for security vulnerabilities.
---
